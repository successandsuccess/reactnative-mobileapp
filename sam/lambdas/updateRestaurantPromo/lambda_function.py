...
def lambda_handler(event, context):
    ...
    if (customer):
        ...
        found       = getPromo(promoStruct, customer)
...
def updatePromo(oldPromoDetails, restaurantId, promoDetails, priceChange, stripeCustomerInfo, dynamodb=None):
    print(promoDetails)
    ...
    try:
        ...
        return getPromo(promoDetails, stripeCustomerInfo, True)
